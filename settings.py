...
SCALE_FACTOR_WIDTH = WIDTH / Background_width
SCALE_FACTOR_HEIGHT = HEIGHT / Background_height
SCALE_FACTOR = max(SCALE_FACTOR_WIDTH, SCALE_FACTOR_HEIGHT)
# Scale the background image
Background = pg.transform.scale(
    Background, (int(Background_width * SCALE_FACTOR), int(Background_height * SCALE_FACTOR))
)
